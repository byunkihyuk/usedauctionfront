...
function GeneralTransactionReceiveBuyRequest() {
    ...
    function onClickRequestStateProgress(item) {
    ...
    return (
        <Layouts>
            ...
            <div className="space-y-2 relative">
                <div className="text-lg font-bold text-left border-b-2">받은 구매 요청</div>
                        ...
                        {vdata && vdata.length > 0 ? (
                            vdata.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="border p-1">{item.buyer}</td>
                                    <td className="border p-1 space-y-1">
                                        ...
                                        item.transactionRequestState === "대기" ? (
                                            <CustomButton
                                                size={"full"}
                                                onClick={() => {
                                                    onClickRequestStateProgress(item);
                                                }}
                                                text={"거래진행"}
                                            ></CustomButton>
                                        ) : (
                                        ...
                                        (item.transactionRequestState === "대기" ||
                                            ...
                                            <CustomButton
                                                size={"full"}
                                                onClick={() => {
                                                    onClickRequestStateCancle(item);
                                                }}
                                                text={"취소"}
                                            ></CustomButton>
                                        ) : (
...
export default GeneralTransactionReceiveBuyRequest;
