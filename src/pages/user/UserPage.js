...
function UserPage() {
    ...
    return (
        <Layouts>
            ...
            <div className="pc:w-[600px] pc:min-h-[600px] mobile:py-5 mobile:px-2 mobile:w-96 h-auto rounded-lg p-5 border-2 border-gray-200 flex flex-col items-center justify-center space-y-5">
                <div className="w-80 min-h-40 flex flex-col items-center justify-center space-y-5">
                    ...
                    <div className="w-full flex space-x-5">
                        ...
                        <div className="w-60 flex items-center justify-start">{data.nickname}</div>
                    </div>
                    {author && (
                        <div className="w-full flex space-x-5">
                ...
                <div className="w-[80%] flex flex-col items-center justify-center">
                    ...
                    {author && (
                        <div
                            className="w-full h-10 flex items-center justify-start text-sm px-5 text-gray-600  border-b-2 cursor-pointer  hover:border-purple-200"
                            onClick={() => movePage(`/user/${data.userId}/general-buy-history`)}
                        >
                            중고 거래 구매 내역
                        </div>
                    )}
                    <div
                        ...
                        onClick={() =>
                            movePage(`/user/${userId ? userId : data.userId}/general-sell-history`)
                        }
                    >
                        중고 거래 판매 내역
                    </div>
