...
function GeneralTransactionPost() {
    ...
    function onClickGeneralTransactionPosting() {
        ...
        fetch(`${process.env.REACT_APP_CLIENT_IP}/api/general`, {
            method: "POST",
            headers: {
            ...
            .then((res) => {
                ...
                if (res.status === "success") {
                    let generalTransactionId = res.data.generalTransactionId;
            ...
            <div className="pc:min-w-[1000px] mobile:w-96 mobile:p-2 flex flex-col items-center justify-center space-y-10">
                ...
                <div className="w-96">
                    <CustomButton
                        text={"중고 거래 등록하기"}
                        size={"full"}
                        onClick={onClickGeneralTransactionPosting}
                    ></CustomButton>
                </div>
            </div>
            {visibleModal && (
...
export default GeneralTransactionPost;
